...
<body>
  <?php require 'header.php'; ?>
    ...
    <div class="container cont">
      ...
      <li class="nav-item">
        <a class="btn btn-outline-primary active" data-toggle="tab" href="#hospitals">Hospitals</a>
      </li>
     <li class="nav-item">
        <a class="btn btn-outline-primary" data-toggle="tab" href="#receivers">Receiver's</a>
     </li>
    </ul>
